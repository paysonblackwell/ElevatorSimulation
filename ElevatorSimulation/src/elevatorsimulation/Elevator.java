...
/*
    The logic behind the elevator has changed by a lot since the start, 
    some clean-up is needed to get rid of methods/variables not used anymore
...
public class Elevator
{
    ...
    //Finds a new destination if needed, also changes the direction to the correct one just in case. Logic should be moved for that
